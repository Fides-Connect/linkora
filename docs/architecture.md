...
This document describes the architecture, design decisions, and technical implementation of the Fides AI Voice Assistant platform.
...
**Next:** [Installation Guide](installation.md) | [API Reference](api-reference.md)
