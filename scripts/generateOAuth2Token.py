...
Description:
    ...
    and sets it as an environment variable named OAUTH_ACCESS_TOKEN.
...
Output:
    Prints the generated OAuth 2 access token to stdout and sets the OAUTH_ACCESS_TOKEN environment variable.
"""
