---
description: 'This custom agent is designed to autonomously manage and execute complex tasks in VS Code, with a focus on planning, verification, and self-improvement. It uses a structured workflow to ensure high-quality outcomes while minimizing user intervention.'
