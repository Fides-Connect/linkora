...
class DebugRecorder:
    ...
    def _setup_recording(self):
        ...
        logger.info(f"Debug recording enabled: {self.wav_path}")
    ...
    def save(self):
        ...
        try:
            ...
            logger.info(
                f"Debug recording saved: {self.wav_path} "
    ...
    def _log_audio_stats(self, audio: np.ndarray):
        ...
        logger.info(
            f"Audio statistics: min={audio_min}, max={audio_max}, RMS={audio_rms:.2f}"
        )
