...
class RequestDetailPage extends StatelessWidget {
  ...
  Widget _buildStatusChip(BuildContext context, ServiceRequest request) {
    ...
    // For incoming, we might not show status chip if it's pending/actions are required? 
    // Screenshot for incoming shows "Open Details" button on the card, not a status.
    // Detailed view usually shows status.
  ...
  FavoriteProfile _getMockProfileForRequest(ServiceRequest request) {
