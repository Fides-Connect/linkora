...
List<ServiceRequest> mockRequests = [
  ServiceRequest(
    ...
    providerUserId: 'current_user',
    providerUserName: 'You',
    providerUserInitials: 'YO',
  ...
  ServiceRequest(
    ...
    providerUserId: 'user_aron',
    providerUserName: 'Aron Neil',
    providerUserInitials: 'AN',
  ...
  ServiceRequest(
    ...
    seekerUserName: 'You',
    seekerUserInitials: 'YO',
    providerUserId: 'user_jared',
    providerUserName: 'Jared Dang',
    providerUserInitials: 'JD',
