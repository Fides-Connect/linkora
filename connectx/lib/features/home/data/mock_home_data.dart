...
List<ServiceRequest> mockRequests = [
  ServiceRequest(
    ...
    seekerUserId: 'user_paul',
    seekerUserName: 'Paul Shatner',
    seekerUserInitials: 'PS',
    selectedProviderUserId: 'current_user',
    selectedProviderUserName: 'You',
    selectedProviderUserInitials: 'YO',
  ...
  ServiceRequest(
    ...
    seekerUserId: 'current_user',
    seekerUserName: 'You',
    seekerUserInitials: 'YO',
    selectedProviderUserId: 'user_aron',
    selectedProviderUserName: 'Aron Neil',
    selectedProviderUserInitials: 'AN',
  ...
  ServiceRequest(
    ...
    seekerUserName: 'You',
    seekerUserInitials: 'YO',
    selectedProviderUserId: 'user_jared',
    selectedProviderUserName: 'Jared Dang',
    selectedProviderUserInitials: 'JD',
