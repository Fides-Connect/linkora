...
void main() {
  ...
  group('AudioRoutingService Integration Tests', () {
    test('initialize sets loudspeaker as default', () async {
    ...
    test('can manually switch to earpiece', () async {
      final service = AudioRoutingService();
      await service.initialize();
    ...
    test('can switch back to loudspeaker', () async {
      final service = AudioRoutingService();
      await service.initialize();
    ...
    test('callback is triggered on routing change', () async {
      final service = AudioRoutingService();
      await service.initialize();
